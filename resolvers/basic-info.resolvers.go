...
// InputBasicInfo is the resolver for the inputBasicInfo field.
func (r *mutationResolver) InputBasicInfo(ctx context.Context, id string, basicInfo *model.BasicInfoInput) (*model.BasicInfo, error) {
	panic(fmt.Errorf("not implemented: InputBasicInfo - inputBasicInfo"))
}
